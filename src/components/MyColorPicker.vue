    ...
    <div ref="container" :class="containerClass">
        ...
        <Portal :appendTo="appendTo" :disabled="inline">
            <transition name="p-connected-overlay" @enter="onOverlayEnter" @leave="onOverlayLeave" @after-leave="onOverlayAfterLeave">
                <div v-if="inline ? true : overlayVisible" :ref="pickerRef" :class="pickerClass" @click="onOverlayClick" style="height: 206px;">
                    ...
                    <InputText type="text" :modelValue="modelValue" style="margin-top: 165px; margin-left: 10px; width: 170px; padding: 3px;"/>
                </div>
            </transition>
        </Portal>
    </div>
